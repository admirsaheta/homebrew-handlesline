class SlineTranspiler < Formula
  ...
  homepage "https://github.com/admirsaheta/homebrew-handlesline"
  url "https://github.com/admirsaheta/homebrew-handlesline/releases/download/v0.1.0/sline-transpiler-0.1.0-x86_64-apple-darwin.tar.gz"
